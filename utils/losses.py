...
class SCELoss(nn.Module):
    def __init__(self, num_classes=7, a=1, b=1):
    ...
    def forward(self, pred, label_one_hot):
        ce = self.cross_entropy(pred, label_one_hot)
        # RCE
...
class AGCELoss(nn.Module):
    def __init__(self, num_classes=7, a=8, q=10, eps=eps, scale=1.):
...
class AUELoss(nn.Module):
    def __init__(self, num_classes=7, a=10, q=10, eps=eps, scale=1.0):
...
class AExpLoss(torch.nn.Module):
    def __init__(self, num_classes=7, a=3, scale=1.0):
